    ...
    module NM1
      ...
      CODES = {
        1 => {
					...
					"b8" => :regular_dealera_business_entity_that_regularly_deals_in_a_commodity_or_service_being_quoted_on_use_of_the_term_"regular_dealer"_is_consistent_with_its_application_to_the_walshhealey_act,
